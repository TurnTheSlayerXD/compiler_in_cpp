...
$"??_C@_06OJLEAOEG@?$CFs?0?5?$CFd?$AA@" = comdat any

$"??_C@_0N@FIHACJEH@Hello?0?5world?$AA@" = comdat any

@"??_C@_06OJLEAOEG@?$CFs?0?5?$CFd?$AA@" = linkonce_odr dso_local unnamed_addr constant [7 x i8] c"%s, %d\00", comdat, align 1
...
define dso_local void @print_str(ptr noundef %0) #0 {
  ...
  %6 = call i32 (ptr, ...) @printf(ptr noundef @"??_C@_06OJLEAOEG@?$CFs?0?5?$CFd?$AA@", ptr noundef %5, i64 noundef %4)
  ret void
}
...
define dso_local i32 @main() #0 {
  call void @print_str(ptr noundef @"??_C@_0N@FIHACJEH@Hello?0?5world?$AA@")
  ret i32 0
}
...
!1 = !DIFile(filename: "test.c", directory: "C:\\Users\\andrey.bazhura\\Desktop\\compiler_in_golang\\cpp")
